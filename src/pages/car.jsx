...
const Car = () => {
  ...
  useEffect(() => {
    ...
    setCar(selectedCar);
    setIsLoading(false); // Marcar la carga como completada cuando se obtiene el auto
  }, []);
        ...
        <div className="mt-8 mb-5 ml-10 mr-10">
          <div className="text-gray-600 inter400 mb-5 w-[93%] m-auto">
            {car && (
              <div className="text-sm">
                ...
                <h1 className="text-white inter600 text-3xl mb-2">
                  {car.model}
                </h1>
                <div>
          ...
          <Accordion className="mt-5">
            <AccordionItem
              subtitle={
                <span>
                  Press to change car <strong>paint</strong>
                </span>
              }
              key="1"
              ...
              <div className="max-xl:flex max-xl:justify-around">
                <div className="flex items-center mt-5">
                  <div
                    ...
                    className="bg-red-500 rounded-md border-2 h-10 w-20 hover:cursor-pointer"
                  ></div>
                ...
                <div className="flex items-center mt-5">
                  <div
                    ...
                    className="bg-blue-500 rounded-md border-2 h-10 w-20 hover:cursor-pointer"
                  ></div>
                ...
                <div className="flex items-center mt-5">
                  <div
                    ...
                    className="bg-yellow-500 rounded-md border-2 h-10 w-20 hover:cursor-pointer"
                  ></div>
                ...
                <div className="flex items-center mt-5">
                  <div
                    ...
                    className="bg-white rounded-md border-2 border-gray-500 h-10 w-20 hover:cursor-pointer"
                  ></div>
                ...
                <div className="flex items-center mt-5">
                  <div
                    ...
                    className="bg-black rounded-md border-gray-500 border-2 h-10 w-20 hover:cursor-pointer"
                  ></div>
            ...
            <AccordionItem
              subtitle={
                <span>
                  Press to change wheels <strong>color</strong>
                </span>
              }
              key="2"
